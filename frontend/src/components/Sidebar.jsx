...
const Sidebar = () => {
  ...
  const linkClasses = ({ isActive }) =>
    `flex items-center px-4 py-2 rounded-lg transition-colors duration-300 whitespace-nowrap ${
      isActive
  ...
  return (
    <aside className="w-full border-b bg-white md:h-screen md:w-64 md:border-b-0 md:border-r">
      {/* User Info */}
      <div className="flex flex-col items-center px-4 py-6 md:mt-6 md:-mx-2">
        <img
          ...
          alt={`${user?.name}'s avatar`}
        />
        <h4 className="mt-2 text-center font-medium text-gray-800">
          {user?.name}
        </h4>
        <p className="mt-1 break-all text-center text-sm font-medium text-gray-600">
          {user?.email}
        </p>
      </div>

      {/* Nav */}
      <div className="mt-2 flex-1 px-3 pb-4 md:mt-6">
        <nav className="flex gap-3 overflow-x-auto md:flex-col md:overflow-x-visible">
          ...
          <NavLink to="/dashboard/schedule" className={linkClasses}>
            <svg
              className="h-5 w-5 shrink-0"
              viewBox="0 0 24 24"
              fill="none"
          ...
          <NavLink to="/dashboard/bookings" className={linkClasses}>
            <svg
              className="h-5 w-5 shrink-0"
              viewBox="0 0 24 24"
              fill="none"
