        ...
        <div className="flex items-center justify-center w-full px-4 py-8 sm:px-6 lg:w-1/3 lg:px-8">
          <div className="w-full max-w-md p-6 bg-white border border-gray-100 shadow-lg rounded-2xl sm:p-8">
            ...
            <div className="mt-8">
              ...
              <p className="mt-3 text-xs text-center text-gray-400 sm:text-sm">
                {role === "mentor"
                  ? "Create your mentor profile and start guiding learners."
                  : "Create your student profile and start learning from experts."}
              </p>
            </div>
          </div>
        </div>
